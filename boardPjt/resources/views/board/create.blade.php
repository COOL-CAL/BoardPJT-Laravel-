...
<head>
    ...
    <title>@isset($data) Edit @else Write @endif</title>
</head>
<body>
    <h1>@isset($data) Edit @else Write @endif</h1>
    <form action="{{ isset($data) ? route('boards.update') : route('board.store') }}" method="post">
